...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView powredBy;

  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView logoSplash, @NonNull ImageView powredBy) {
    this.rootView = rootView;
    this.logoSplash = logoSplash;
    this.powredBy = powredBy;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.powred_by;
      ImageView powredBy = rootView.findViewById(id);
      if (powredBy == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, logoSplash, powredBy);
    }
